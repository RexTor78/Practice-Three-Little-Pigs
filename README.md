...
<img src="img/lobo-galactico.png" alt="Imagen Lobo galactico" width="300"/ >
...
Cerdito Beta (Unidad 02) – Técnico en metalurgia espacial, nivel intermedio.

Cerdito Gamma (Unidad 03) – Ingeniero orbital de rango Maestro, acreditado por la Academia de Mithril Estelar.
...
Cada unidad construyó una base:

Base Alfa: Estructura ligera de chatarra — eficiencia alta, resistencia mínima.

Base Beta: Placas metálicas recicladas — resistencia moderada, pobre tolerancia gravitacional.

Base Gamma: Estación orbital reforzada con aleación de mithril estelar — resistencia superior, escudos energéticos de última generación.

La entidad conocida como Lobo Galáctico detectó actividad electromagnética inusual y procedió a evaluar la integridad de las construcciones.
Resultados:

Base Alfa: desintegrada.

Base Beta: destruida tras exposición a radiación solar intensificada.

Base Gamma: resistencia total; reflejó el ataque generando una explosión lumínica que expulsó a la entidad hostil fuera del sector.
...
Recursos gráficos almacenados en formato PNG
...
Obtener (clonar/descargar) el repositorio.

Confirmar la integridad de la carpeta /img.

Abrir index.html con un navegador estándar.
...
— Consejo de Archivos Universales, Año Estelar 2025
